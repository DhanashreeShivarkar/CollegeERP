...
class EMPLOYEE_MASTER(AuditModel):
    ...
    PERMANENT_ADDRESS = models.TextField(db_column='PERMANENT_ADDRESS', default='N/A')
    ...
    PERMANENT_CITY = models.CharField(max_length=50, db_column='PERMANENT_CITY', default='N/A')
    PERMANENT_PIN = models.CharField(max_length=6, db_column='PERMANENT_PIN', default='N/A')
    ...
    DATE_OF_JOIN = models.DateField(db_column='DATE_OF_JOIN', default='1900-01-01')
    ...
    POSITION = models.CharField(max_length=50, db_column='POSITION', default='N/A')
    SHIFT = models.ForeignKey(SHIFT_MASTER, on_delete=models.PROTECT, db_column='SHIFT', default=1)
    ...
    MOBILE_NO = models.CharField(max_length=15, db_column='MOBILE_NO', default='N/A')
